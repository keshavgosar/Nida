...
extracted_time = open('C:\\Users\\keshav\\Desktop\\NidaAI\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\Users\\keshav\\Desktop\\NidaAI\\Data.txt",'r+')
...
def RingerNow(time):
    ...
    time_now = time_to_set.replace("nida","")
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("C:\\Users\\keshav\\Desktop\\NidaAI\\DataBase\\Sounds\\1.mp3")
